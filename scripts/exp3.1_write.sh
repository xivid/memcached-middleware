...
# usage: ./exp3.1_write.sh [time] [repetitions] [nopop]
...
logfile="exp3.1_write_${VM_NAME}.log"
...
fnamepart="../logs/3.1"
workloads=("writeonly")
clients=(1 2 3 4 6 8 16 32)
workers=(8 16 32 64)

echolog "# ASL section 3.1 writeonly experiments"
...
echolog "# ASL section 3.1 writeonly experiments ALL DONE."