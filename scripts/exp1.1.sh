...
# usage: ./exp1.1.sh [test time] [repetitions] [nopop]
...
echolog "# ASL section 1.1 experiments"
...
[ -e ${fnamepart} ] && backup="../logs/backup1.1_$(date +%Y-%m-%d_%H-%M-%S)" && echolog "Old data folder found, renaming to ${backup}" && mv ${fnamepart} ${backup}
echolog
mkdir -p ${fnamepart}
...
echolog "# ASL section 1.1 experiments ALL DONE."
