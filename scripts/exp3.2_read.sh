...
# usage: ./exp3.2_read.sh [time] [repetitions] [nopop]
...
logfile="exp3.2_read_${VM_NAME}.log"
...
echolog "# ASL section 3.2 readonly experiments"
...
echolog "# ASL section 3.2 readonly experiments ALL DONE."